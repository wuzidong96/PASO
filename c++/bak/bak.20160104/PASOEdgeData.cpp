...
time_min_(0), time_max_(0), grade_(0), coef_a_(0), coef_b_(0), coef_c_(0), coef_d_(0)
{    
}
...
{
    os << "(valid,src,des,distance,speed_min,speed_max,time_min,time_max,grade,coef_a,coef_b,coef_c,coef_d,label)=("
    << e.valid_ << ","
    << e.src_ << ","
    << e.des_ << ","
    << e.distance_ << ","
