...
% figure;
% hold on;
% plot(2*t1,f1, 'b', 'linewidth',3);
% plot(2*t2,f2,'r', 'linewidth',3);
...
figure;
hold on;
plot(lambda1, 2*w1, 'b', 'linewidth',3);
plot(lambda2, 2*w2,'r', 'linewidth',3);
%plot(lambda1, 2*tt1,'b', 'linewidth',3);
%plot(lambda2, 2*tt2,'r', 'linewidth',3);
%legend('Path1: (1->2->4)', 'Path2: (1->3->4)', 'time path1', 'time path2');
legend('Path1: (1->2->4)', 'Path2: (1->3->4)');
xlabel('$\lambda$','FontSize', 20, 'Interpreter', 'latex');
%ylabel('$w(\lambda)$','FontSize', 20, 'Interpreter', 'latex');
title('total weight');
hold off;
grid on;
box on;
...
figure;
hold on;
plot(lambda1, 2*fuel_cost1, 'b', 'linewidth',3);
plot(lambda2, 2*fuel_cost2,'r', 'linewidth',3);
%plot(lambda1, 2*delay_cost1,'b', 'linewidth',3);
%plot(lambda2, 2*delay_cost2,'r', 'linewidth',3);
legend('Path1: (1->2->4)', 'Path2: (1->3->4)');
xlabel('$\lambda$','FontSize', 20, 'Interpreter', 'latex');
title('Fuel cost');
%ylabel('$w(\lambda)$','FontSize', 20, 'Interpreter', 'latex');
...
figure;
hold on;
plot(lambda1, 2*(w1-w2), 'g', 'linewidth', 3);
plot(lambda1, 2*(fuel_cost1-fuel_cost2),'b', 'linewidth',3);
plot(lambda2, 2*(delay_cost2-delay_cost1),'r', 'linewidth',3);
legend('total diff', 'fuel cost diff', '-delay cost diff');
xlabel('$\lambda$','FontSize', 20, 'Interpreter', 'latex');
title('Difference of cost');
%ylabel('$w(\lambda)$','FontSize', 20, 'Interpreter', 'latex');
hold off;
grid on;
box on;
