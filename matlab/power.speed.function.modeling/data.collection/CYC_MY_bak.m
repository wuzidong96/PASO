% ADVISOR data file:  CYC_CONSTANT_45.m
%
% Data source: Valerie Johnson, NREL
%
% Data confirmation:
%
% Notes: Requests a constant 45 mph speed of the vehicle for 50s.
% 
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='Constant speed cycle';
...
disp(['Data loaded: CYC_CONSTANT_45 - ',cyc_description])
...
% 1/18/00:tm created based on cyc_constant
